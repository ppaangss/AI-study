...
| `topics/<카테고리>/<주제>.md` 또는 `topics/<주제>.md` | 주제별 이력 테이블 (링크만) | sync 스크립트만 (직접 편집 금지) |
...
index 파일명은 공백을 그대로 쓴다 (하이픈·언더스코어로 치환하지 않음). 영어 개념은 영어 prefix 그대로 (예: `redis 개요.md`, `skip list.md`).
